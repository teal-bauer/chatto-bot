...
_BotInfoFields: TypeAlias = Literal["owner_user_id"]

class BotInfo(Message[_BotInfoFields]):
    """
...
_UserFields: TypeAlias = Literal["id", "login", "display_name", "deleted", "avatar_url", "presence_status", "custom_status", "bio", "timezone", "bot"]
...
class User(Message[_UserFields]):
    ...
    Attributes:
        ...
        bot:
            ...
            ```proto
            optional chatto.api.v1.BotInfo bot = 11;
            ```
    """

    __slots__ = ("id", "login", "display_name", "deleted", "avatar_url", "presence_status", "custom_status", "bio", "timezone", "bot")
