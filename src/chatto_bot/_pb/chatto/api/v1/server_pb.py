...
_ServerLoginFields: TypeAlias = Literal["direct_registration_enabled", "providers", "authorize_url", "account_creation_policy", "direct_login_enabled"]
...
class ServerLogin(Message[_ServerLoginFields]):
    ...
    Attributes:
        ...
        account_creation_policy:
            ...
            ```proto
            chatto.api.v1.AccountCreationPolicy account_creation_policy = 4;
            ```
    ...
    __slots__ = ("direct_registration_enabled", "providers", "authorize_url", "account_creation_policy", "direct_login_enabled")
    ...
    if TYPE_CHECKING:
        ...
        def __init__(
            ...
            *,
            ...
            authorize_url: str = "",
            account_creation_policy: AccountCreationPolicy | None = None,
            direct_login_enabled: bool | None = None,
        ) -> None:
            pass
...
class AccountCreationPolicy(Enum):
    ...
    ```proto
    enum chatto.api.v1.AccountCreationPolicy
    ```
