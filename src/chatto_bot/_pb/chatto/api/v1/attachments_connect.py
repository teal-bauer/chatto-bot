...
class AssetService(Protocol):
    ...
    async def batch_get_assets(self, request: BatchGetAssetsRequest, ctx: RequestContext[BatchGetAssetsRequest, BatchGetAssetsResponse], /) -> BatchGetAssetsResponse:
        ...
        required. Assets also require message.read or a matching thread
        relationship with message.read-interactions. Missing, deleted, wrong-room, and inaccessible asset
    ...
    def desc(cls) -> DescService:
        ...
        return next(s for s in attachments_pb.desc().services if s.type_name == 'chatto.api.v1.AssetService')
